...
def detect(save_img=False):
    # =============================================================================================================================
    save_solar_panels_path = "0_save_solar_panels"
    save_full_img_path = "1_save_full_img"
    saved_solar_panels_count = 0

    # Handeling when to save the solar panel
    in_offset_old = False
    in_offset_new = False
    # =============================================================================================================================
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                # Saving bounding box image when inside offset
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if rising_edge_in_offset:
                        ...
                        cv2.circle(im0, (_x, _y), radius, color, thickness)

                        # Calculate the coordinates for the center of the rectangle
                        rect_x_center = im0.shape[1] // 2
                        rect_y_center = im0.shape[0] // 2

                        # Calculate the width and height of the rectangle
                        rect_width = im_w // 4 
                        rect_height = im0.shape[0] // 2  # You can use im_h if it's not the same as im0.shape[0]
                        ...
                        # Draw the rectangle
                        color = (0, 0, 255, 0.1)
                        cv2.rectangle(im0, (rect_x1, rect_y1), (rect_x2, rect_y2), color, thickness)
